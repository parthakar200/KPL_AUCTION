...
//     await call(async () => { await api.editPlayer(editModal.id, { name: editModal.name.trim(), category: editModal.category, role: editModal.role, basePrice: editModal.basePrice, photo: editModal.photo || null }); return api.getFullState(); }, `✏️ ${editModal.name} updated!`);
//     setEditModal(null);
//   };
