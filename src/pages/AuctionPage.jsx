...
//         </div>
//       )}
//       <div style={{ position: 'relative', zIndex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8, marginBottom: 10, flexWrap: 'wrap' }}>
...
//       <div style={{ background: 'var(--bg-card2)', border: '1px solid var(--border)', borderRadius: 10, padding: 14, marginBottom: 14, position: 'relative', zIndex: 1 }}>
...
//           .auction-recent-row { flex-wrap: wrap; gap: 6px !important; }
//         }
//       `}</style>
...
//                 return (
//                   <div key={i} className="auction-recent-row" style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '8px 10px', background: isSold ? 'rgba(34,197,94,0.06)' : 'rgba(239,68,68,0.06)', border: `1px solid ${isSold ? 'rgba(34,197,94,0.2)' : 'rgba(239,68,68,0.2)'}`, borderRadius: 8 }}>
...
//                     {isSold && team ? (
//                       <>
//                         <span style={{ fontSize: 12, fontWeight: 700, color: team.color, flexShrink: 0 }}>{team.name}</span>
//                         <span style={{ fontFamily: 'var(--font-mono)', fontSize: 13, color: 'var(--gold)', fontWeight: 700, flexShrink: 0 }}>{r.amount} pts</span>
//                       </>
//                     ) : (
...
//                   style={{ flex: 1, minWidth: 0, padding: '10px 6px', fontSize: 10, fontWeight: 700, fontFamily: 'var(--font-body)', border: 'none', cursor: 'pointer', transition: 'all 0.15s', whiteSpace: 'nowrap', background: isActive ? 'var(--bg-card2)' : 'transparent', color: isActive ? t.color : 'var(--text-muted)', borderBottom: `2px solid ${isActive ? t.color : 'transparent'}`, letterSpacing: 0.5 }}>
//                   {t.label}{' '}
