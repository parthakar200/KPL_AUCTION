...
// .page-header{padding:28px 32px 0;border-bottom:1px solid var(--border);background:var(--bg-card);margin-bottom:28px;display:flex;align-items:flex-start;justify-content:space-between;flex-wrap:wrap;gap:8px;}
...
//   /* Auction — stack completely */
//   .auction-layout{grid-template-columns:1fr;gap:12px;}
//   .auction-player-display{padding:16px;}
//   .auction-player-name{font-size:28px !important;}
//   .bid-amount{font-size:36px !important;}
...
//   .player-queue{max-height:200px;}

//   /* Hide scrollbar on queue tabs */
